# Generated by Django 3.2.6 on 2021-08-18 11:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('true_layer', '0001_initial'),
    ]

    operations = [
        migrations.AlterField(
            model_name='truelayerauth',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='truelayer_accounts', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_logo_uri', models.CharField(blank=True, max_length=50, null=True)),
